...
#print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches()) # Error number_of_days_in_a_week_silicon_or_triangle_sides is no defined
...
def add(b,c):
  print(b+c)
#print(add(1,2) + add(2,3)) #TypeError: unsupported operand type(s) for +: 'NoneType' and 'NoneType'


# #7
def concatenate(b,c):
  return str(b)+str(c)
print(concatenate(2,5))#25 in string
...
def number_of_oceans_or_fingers_or_continents():
  ...
  if b < 10:
    ...
    return 10
  return 7
print(number_of_oceans_or_fingers_or_continents())# first print 100 , second 10
